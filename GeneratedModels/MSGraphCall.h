...
@interface MSGraphCall : MSGraphEntity
  ...
  @property (nullable, nonatomic, setter=setState:, getter=state) MSGraphCallState* state;
    ...
    @property (nullable, nonatomic, setter=setCallRoutes:, getter=callRoutes) NSArray* callRoutes;
    ...
    @property (nullable, nonatomic, setter=setCallChainId:, getter=callChainId) NSString* callChainId;
    @property (nullable, nonatomic, setter=setIncomingContext:, getter=incomingContext) MSGraphIncomingContext* incomingContext;
