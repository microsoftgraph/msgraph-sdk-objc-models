...
@interface MSGraphDeviceComplianceUserOverview()
{
...
@implementation MSGraphDeviceComplianceUserOverview

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.deviceComplianceUserOverview";
    }
    return self;
}
