...
@class MSGraphApproval, MSGraphAccessPackage, MSGraphAccessPackageAssignmentPolicy, MSGraphAccessPackageAssignmentRequest, MSGraphAccessPackageAssignment, MSGraphAccessPackageCatalog, MSGraphConnectedOrganization, MSGraphEntitlementManagementSettings; 
...
@interface MSGraphEntitlementManagement : MSGraphEntity
  ...
  @property (nullable, nonatomic, setter=setAccessPackageAssignmentApprovals:, getter=accessPackageAssignmentApprovals) NSArray* accessPackageAssignmentApprovals;
    ...
    @property (nullable, nonatomic, setter=setAssignmentPolicies:, getter=assignmentPolicies) NSArray* assignmentPolicies;
