...
@class MSGraphDeviceManagementSettings, MSGraphIntuneBrand, MSGraphTermsAndConditions, MSGraphDeviceCompliancePolicy, MSGraphDeviceCompliancePolicyDeviceStateSummary, MSGraphDeviceCompliancePolicySettingStateSummary, MSGraphDeviceConfigurationDeviceStateSummary, MSGraphDeviceConfiguration, MSGraphIosUpdateDeviceStatus, MSGraphSoftwareUpdateStatusSummary, MSGraphComplianceManagementPartner, MSGraphOnPremisesConditionalAccessSettings, MSGraphDeviceCategory, MSGraphDeviceEnrollmentConfiguration, MSGraphDeviceManagementPartner, MSGraphDeviceManagementExchangeConnector, MSGraphMobileThreatDefenseConnector, MSGraphApplePushNotificationCertificate, MSGraphDetectedApp, MSGraphManagedDeviceOverview, MSGraphManagedDevice, MSGraphImportedWindowsAutopilotDeviceIdentity, MSGraphWindowsAutopilotDeviceIdentity, MSGraphNotificationMessageTemplate, MSGraphResourceOperation, MSGraphDeviceAndAppManagementRoleAssignment, MSGraphRoleDefinition, MSGraphRemoteAssistancePartner, MSGraphDeviceManagementReports, MSGraphTelecomExpenseManagementPartner, MSGraphDeviceManagementTroubleshootingEvent, MSGraphWindowsInformationProtectionAppLearningSummary, MSGraphWindowsInformationProtectionNetworkLearningSummary; 
...
@interface MSGraphDeviceManagement : MSGraphEntity
  ...
  @property (nonnull, nonatomic, setter=setIntuneAccountId:, getter=intuneAccountId) NSString* intuneAccountId;
    ...
    @property (nullable, nonatomic, setter=setImportedWindowsAutopilotDeviceIdentities:, getter=importedWindowsAutopilotDeviceIdentities) NSArray* importedWindowsAutopilotDeviceIdentities;
    @property (nullable, nonatomic, setter=setWindowsAutopilotDeviceIdentities:, getter=windowsAutopilotDeviceIdentities) NSArray* windowsAutopilotDeviceIdentities;
    ...
    @property (nullable, nonatomic, setter=setReports:, getter=reports) MSGraphDeviceManagementReports* reports;
