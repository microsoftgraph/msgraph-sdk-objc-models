...
@class MSGraphConditionalAccessApplications, MSGraphConditionalAccessClientApplications, MSGraphConditionalAccessDevices, MSGraphConditionalAccessLocations, MSGraphConditionalAccessPlatforms, MSGraphConditionalAccessUsers; 
...
@property (nullable, nonatomic, setter=setClientApplications:, getter=clientApplications) MSGraphConditionalAccessClientApplications* clientApplications;
...
@property (nullable, nonatomic, setter=setUsers:, getter=users) MSGraphConditionalAccessUsers* users;
