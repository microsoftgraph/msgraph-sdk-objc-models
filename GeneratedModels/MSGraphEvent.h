...
@class MSGraphAttendee, MSGraphItemBody, MSGraphDateTimeTimeZone, MSGraphLocation, MSGraphOnlineMeetingInfo, MSGraphRecipient, MSGraphPatternedRecurrence, MSGraphResponseStatus, MSGraphAttachment, MSGraphCalendar, MSGraphExtension, MSGraphMultiValueLegacyExtendedProperty, MSGraphSingleValueLegacyExtendedProperty; 
