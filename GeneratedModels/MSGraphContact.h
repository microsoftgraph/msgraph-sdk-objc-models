...
@class MSGraphPhysicalAddress, MSGraphEmailAddress, MSGraphExtension, MSGraphMultiValueLegacyExtendedProperty, MSGraphProfilePhoto, MSGraphSingleValueLegacyExtendedProperty; 
