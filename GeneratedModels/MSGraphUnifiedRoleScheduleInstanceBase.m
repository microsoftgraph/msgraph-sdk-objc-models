...
@interface MSGraphUnifiedRoleScheduleInstanceBase()
{
...
@implementation MSGraphUnifiedRoleScheduleInstanceBase

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.unifiedRoleScheduleInstanceBase";
    }
    return self;
}
- (NSString*) appScopeId
