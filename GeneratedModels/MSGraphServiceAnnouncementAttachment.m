...
@interface MSGraphServiceAnnouncementAttachment()
{
...
@implementation MSGraphServiceAnnouncementAttachment

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.serviceAnnouncementAttachment";
    }
    return self;
}
