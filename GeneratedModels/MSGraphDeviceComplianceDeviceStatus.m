...
@interface MSGraphDeviceComplianceDeviceStatus()
{
...
@implementation MSGraphDeviceComplianceDeviceStatus

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.deviceComplianceDeviceStatus";
    }
    return self;
}
