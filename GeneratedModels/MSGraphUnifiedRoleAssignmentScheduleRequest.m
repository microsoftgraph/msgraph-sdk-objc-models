...
@interface MSGraphUnifiedRoleAssignmentScheduleRequest()
{
    ...
    MSGraphUnifiedRoleAssignmentSchedule* _targetSchedule;
}
@end

@implementation MSGraphUnifiedRoleAssignmentScheduleRequest

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.unifiedRoleAssignmentScheduleRequest";
    }
    return self;
}
...
- (MSGraphUnifiedRoleAssignmentSchedule*) targetSchedule
{
    if(!_targetSchedule){
        _targetSchedule = [[MSGraphUnifiedRoleAssignmentSchedule alloc] initWithDictionary: self.dictionary[@"targetSchedule"]];
    }
    return _targetSchedule;
}

- (void) setTargetSchedule: (MSGraphUnifiedRoleAssignmentSchedule*) val
{
    _targetSchedule = val;
