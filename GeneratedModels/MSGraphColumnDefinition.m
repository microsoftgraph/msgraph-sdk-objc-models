...
@interface MSGraphColumnDefinition()
{
    ...
    BOOL _required;
    MSGraphContentTypeInfo* _sourceContentType;
...
- (MSGraphContentTypeInfo*) sourceContentType
{
    if(!_sourceContentType){
        _sourceContentType = [[MSGraphContentTypeInfo alloc] initWithDictionary: self.dictionary[@"sourceContentType"]];
    }
    return _sourceContentType;
}

- (void) setSourceContentType: (MSGraphContentTypeInfo*) val
{
    _sourceContentType = val;
    self.dictionary[@"sourceContentType"] = val;
}
