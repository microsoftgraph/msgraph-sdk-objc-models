...
@class MSGraphAudioConferencing, MSGraphBroadcastMeetingSettings, MSGraphChatInfo, MSGraphItemBody, MSGraphLobbyBypassSettings, MSGraphMeetingParticipants, MSGraphMeetingAttendanceReport; 
...
@interface MSGraphOnlineMeeting : MSGraphEntity
  ...
  @property (nonatomic, setter=setAllowAttendeeToEnableCamera:, getter=allowAttendeeToEnableCamera) BOOL allowAttendeeToEnableCamera;
    ...
    @property (nonatomic, setter=setRecordAutomatically:, getter=recordAutomatically) BOOL recordAutomatically;
    ...
    @property (nullable, nonatomic, setter=setAttendanceReports:, getter=attendanceReports) NSArray* attendanceReports;
