...
@interface MSGraphEdiscoverySourceCollection()
{
    ...
    MSGraphEdiscoveryAddToReviewSetOperation* _addToReviewSetOperation;
...
- (MSGraphEdiscoveryAddToReviewSetOperation*) addToReviewSetOperation
{
    if(!_addToReviewSetOperation){
        _addToReviewSetOperation = [[MSGraphEdiscoveryAddToReviewSetOperation alloc] initWithDictionary: self.dictionary[@"addToReviewSetOperation"]];
    }
    return _addToReviewSetOperation;
}

- (void) setAddToReviewSetOperation: (MSGraphEdiscoveryAddToReviewSetOperation*) val
{
    _addToReviewSetOperation = val;
    self.dictionary[@"addToReviewSetOperation"] = val;
}
