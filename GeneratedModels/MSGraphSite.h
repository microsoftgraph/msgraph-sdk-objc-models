...
@class MSGraphPublicError, MSGraphRoot, MSGraphSharepointIds, MSGraphSiteCollection, MSGraphItemAnalytics, MSGraphColumnDefinition, MSGraphContentType, MSGraphDrive, MSGraphBaseItem, MSGraphList, MSGraphRichLongRunningOperation, MSGraphPermission, MSGraphTermStoreStore, MSGraphOnenote; 
...
@interface MSGraphSite : MSGraphBaseItem
  ...
  @property (nullable, nonatomic, setter=setDisplayName:, getter=displayName) NSString* displayName;
    ...
    @property (nullable, nonatomic, setter=setExternalColumns:, getter=externalColumns) NSArray* externalColumns;
    ...
    @property (nullable, nonatomic, setter=setSiteOperations:, getter=siteOperations) NSArray* siteOperations;
