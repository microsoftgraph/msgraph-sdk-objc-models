...
@interface MSGraphSearchRequest()
{
    ...
    MSGraphSearchAlterationOptions* _queryAlterationOptions;
...
- (MSGraphSearchAlterationOptions*) queryAlterationOptions
{
    if(!_queryAlterationOptions){
        _queryAlterationOptions = [[MSGraphSearchAlterationOptions alloc] initWithDictionary: self.dictionary[@"queryAlterationOptions"]];
    }
    return _queryAlterationOptions;
}

- (void) setQueryAlterationOptions: (MSGraphSearchAlterationOptions*) val
{
    _queryAlterationOptions = val;
    self.dictionary[@"queryAlterationOptions"] = val;
}
