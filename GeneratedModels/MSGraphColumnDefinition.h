...
@class MSGraphBooleanColumn, MSGraphCalculatedColumn, MSGraphChoiceColumn, MSGraphContentApprovalStatusColumn, MSGraphCurrencyColumn, MSGraphDateTimeColumn, MSGraphDefaultColumnValue, MSGraphGeolocationColumn, MSGraphHyperlinkOrPictureColumn, MSGraphLookupColumn, MSGraphNumberColumn, MSGraphPersonOrGroupColumn, MSGraphContentTypeInfo, MSGraphTermColumn, MSGraphTextColumn, MSGraphThumbnailColumn, MSGraphColumnValidation; 
...
@interface MSGraphColumnDefinition : MSGraphEntity
  ...
  @property (nullable, nonatomic, setter=setBoolean:, getter=boolean) MSGraphBooleanColumn* boolean;
    ...
    @property (nullable, nonatomic, setter=setSourceContentType:, getter=sourceContentType) MSGraphContentTypeInfo* sourceContentType;
