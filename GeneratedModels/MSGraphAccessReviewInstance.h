...
@class MSGraphAccessReviewReviewerScope, MSGraphAccessReviewScope, MSGraphAccessReviewReviewer, MSGraphAccessReviewInstanceDecisionItem; 
...
@interface MSGraphAccessReviewInstance : MSGraphEntity
  ...
  @property (nullable, nonatomic, setter=setEndDateTime:, getter=endDateTime) NSDate* endDateTime;
    ...
    @property (nullable, nonatomic, setter=setContactedReviewers:, getter=contactedReviewers) NSArray* contactedReviewers;
