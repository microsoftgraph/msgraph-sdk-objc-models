...
@class MSGraphRequestSchedule, MSGraphTicketInfo, MSGraphAppScope, MSGraphDirectoryObject, MSGraphUnifiedRoleDefinition, MSGraphUnifiedRoleEligibilitySchedule; 
#import "MSGraphUnifiedRoleScheduleRequestActions.h"


#import "MSGraphRequest.h"

@interface MSGraphUnifiedRoleEligibilityScheduleRequest : MSGraphRequest
  ...
  @property (nullable, nonatomic, setter=setAction:, getter=action) MSGraphUnifiedRoleScheduleRequestActions* action;
    ...
    @property (nullable, nonatomic, setter=setTargetSchedule:, getter=targetSchedule) MSGraphUnifiedRoleEligibilitySchedule* targetSchedule;
