...
@interface MSGraphDeviceConfigurationUserOverview()
{
...
@implementation MSGraphDeviceConfigurationUserOverview

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.deviceConfigurationUserOverview";
    }
    return self;
}
