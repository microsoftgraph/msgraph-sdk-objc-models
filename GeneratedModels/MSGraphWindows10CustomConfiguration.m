...
@interface MSGraphWindows10CustomConfiguration()
{
    NSArray* _omaSettings;
}
@end

@implementation MSGraphWindows10CustomConfiguration

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.windows10CustomConfiguration";
    }
    return self;
}
- (NSArray*) omaSettings
