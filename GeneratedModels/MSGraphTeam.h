...
@class MSGraphTeamMemberSettings, MSGraphTeamGuestSettings, MSGraphTeamMessagingSettings, MSGraphTeamFunSettings, MSGraphSchedule, MSGraphGroup, MSGraphTeamsTemplate, MSGraphConversationMember, MSGraphChannel, MSGraphTeamsAppInstallation, MSGraphTeamsAsyncOperation; 
