...
@class MSGraphChatMessageAttachment, MSGraphItemBody, MSGraphChannelIdentity, MSGraphEventMessageDetail, MSGraphChatMessageFromIdentitySet, MSGraphChatMessageMention, MSGraphChatMessagePolicyViolation, MSGraphChatMessageReaction, MSGraphChatMessageHostedContent; 
...
@interface MSGraphChatMessage : MSGraphEntity
  ...
  @property (nullable, nonatomic, setter=setAttachments:, getter=attachments) NSArray* attachments;
    ...
    @property (nullable, nonatomic, setter=setEventDetail:, getter=eventDetail) MSGraphEventMessageDetail* eventDetail;
