...
@interface MSGraphDeviceConfigurationDeviceOverview()
{
...
@implementation MSGraphDeviceConfigurationDeviceOverview

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.deviceConfigurationDeviceOverview";
    }
    return self;
}
