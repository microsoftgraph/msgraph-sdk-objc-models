...
@class MSGraphTeamworkOnlineMeetingInfo, MSGraphTeamsAppInstallation, MSGraphConversationMember, MSGraphChatMessage, MSGraphTeamsTab; 
...
@interface MSGraphChat : MSGraphEntity
  ...
  @property (nonnull, nonatomic, setter=setChatType:, getter=chatType) MSGraphChatType* chatType;
    ...
    @property (nullable, nonatomic, setter=setOnlineMeetingInfo:, getter=onlineMeetingInfo) MSGraphTeamworkOnlineMeetingInfo* onlineMeetingInfo;
