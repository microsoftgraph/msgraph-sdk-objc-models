...
@interface MSGraphDeviceComplianceDeviceOverview()
{
...
@implementation MSGraphDeviceComplianceDeviceOverview

- (id) init
{
    if (self = [super init]) {
        self.oDataType = @"#microsoft.graph.deviceComplianceDeviceOverview";
    }
    return self;
}
