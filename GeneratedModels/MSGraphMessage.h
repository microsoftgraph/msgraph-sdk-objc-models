...
@class MSGraphRecipient, MSGraphItemBody, MSGraphFollowupFlag, MSGraphInternetMessageHeader, MSGraphAttachment, MSGraphExtension, MSGraphMultiValueLegacyExtendedProperty, MSGraphSingleValueLegacyExtendedProperty; 
